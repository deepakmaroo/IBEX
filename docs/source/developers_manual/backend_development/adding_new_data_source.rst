...
#. The :py:class:`~ibex.data_source.data_source_interface.DataSourceInterface` must be implemented, and the resulting class should be made accessible to the Python interpreter (e.g. by ensuring proper module packaging or configuring the PYTHONPATH).
