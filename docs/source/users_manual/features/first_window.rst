...
.. image:: images/first_window.png
   :alt: First ibex window
   :align: center

On this screen, you will be required to either create a new configuration (“:doc:`Add configuration <add_configuration>`”) or load an existing one from your local machine (“:doc:`Load configuration <load_configuration>`”).
